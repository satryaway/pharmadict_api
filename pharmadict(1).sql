...
--
-- Host: localhost
-- Generation Time: Jul 05, 2015 at 08:39 PM
...
CREATE TABLE IF NOT EXISTS `jenis_obat` (
  `jenis_obat_id` int(2) NOT NULL AUTO_INCREMENT,
  `jenis_obat_nama` varchar(255) NOT NULL,
  PRIMARY KEY (`jenis_obat_id`)
...
INSERT INTO `jenis_obat` (`jenis_obat_id`, `jenis_obat_nama`) VALUES
(1, 'Tablet'),
(2, 'Kapsul'),
(3, 'Sirup'),
(4, 'Puyer'),
...
CREATE TABLE IF NOT EXISTS `kode_obat` (
  `id_kode_obat` int(1) NOT NULL,
  `nama_kode_obat` varchar(10) NOT NULL,
  `warna_kode_obat` varchar(10) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `kode_obat` (`id_kode_obat`, `nama_kode_obat`, `warna_kode_obat`) VALUES
(1, 'Ringan', 'Hijau'),
(2, 'Sedang', 'Biru'),
(3, 'Keras', 'Merah');
...
CREATE TABLE IF NOT EXISTS `obat` (
  ...
  `obat_harga` varchar(255) NOT NULL,
  `obat_jenis` varchar(255) NOT NULL,
  `obat_pic` varchar(255) NOT NULL,
  `obat_efeksamping` varchar(255) NOT NULL,
  `obat_dosis` varchar(255) NOT NULL,
  `obat_perhatian` varchar(255) NOT NULL,
  `obat_isi` varchar(255) NOT NULL,
